          ...
          <tr>
            ...
            <th className="flex justify-end">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-gray-600 transition-colors"
              >
