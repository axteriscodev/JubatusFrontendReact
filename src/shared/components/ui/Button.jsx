...
const Button = ({
  ...
  const variantClasses = {
    primary: 'bg-primary text-bg border-3 border-primary hover:bg-secondary-event hover:border-secondary-event rounded-full',
    secondary: 'bg-secondary text-white border-3 border-secondary hover:bg-secondary-event/90 rounded-full',
    success: 'bg-success text-white border-3 border-success hover:bg-success/90 rounded-full',
    danger: 'bg-danger text-white border-3 border-danger hover:bg-danger/90 rounded-full',
    link: 'text-secondary-event hover:text-secondary-event/80 underline bg-transparent border-0',
    outline: 'bg-transparent text-primary border-3 border-primary hover:bg-primary hover:text-bg rounded-full',
  };
